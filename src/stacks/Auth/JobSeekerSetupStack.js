...
const JobSeekerSetupStack = () => {
    return (
        <Stack.Navigator>
            <Stack.Screen options={{ headerShown: false }} name={'JobSetup'} component={JobSetup} ></Stack.Screen>
            ...
            <Stack.Screen options={{ headerShown: false }} name={'SemiVerifed'} component={SemiVerifed} ></Stack.Screen>
