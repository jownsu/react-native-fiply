                    ...
                    <View style={styles.bodyContainer}>
                        <View style={styles.actionContainer}>
                            ...
                            <Switch
                                ...
                                value={activeSwitch.post}
                                onValueChange={() =>
                                    toggleSwitch({ post: !activeSwitch.post })
                                }
                        ...
                        <View style={styles.actionContainer}>
                            ...
                            <Switch
                                style={styles.swithStyle}
                                value={activeSwitch.sharedPost}
                                onValueChange={() =>
                                    toggleSwitch({
                                        sharedPost: !activeSwitch.sharedPost,
                                    })
                                }
                                color={Colors.primary}
                            />
                        ...
                        <View style={styles.actionContainer}>
                            ...
                            <Switch
                                style={styles.swithStyle}
                                value={activeSwitch.bookmarkedPost}
                                onValueChange={() =>
                                    toggleSwitch({
                                        bookmarkedPost:
                                            !activeSwitch.bookmarkedPost,
                                    })
                                }
                                color={Colors.primary}
                            />
                        ...
                        <View style={styles.actionContainer}>
                            ...
                            <Switch
                                style={styles.swithStyle}
                                value={activeSwitch.mostUpvoted}
                                onValueChange={() =>
                                    toggleSwitch({
                                        mostUpvoted: !activeSwitch.mostUpvoted,
                                    })
                                }
                                color={Colors.primary}
                            />
