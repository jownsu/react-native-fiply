...
import { SafeAreaView, Text, Container, FlatList, SecondaryButton } from '../../components/FiplyComponents'
    ...
    const renderFellowList = (item, index) => {
        return(
            <View style={fellowListStyles.cardContainer}>
                <TouchableOpacity activeOpacity={1} onPress={() => setActiveIndex(-1) } style={ activeIndex == index ? {...fellowListStyles.blackBG} : {} } />
                <View style={{ paddingHorizontal: 5, paddingVertical: 20 }}>
                    <View style={fellowListStyles.dotBtnContainer}>
                        <TouchableOpacity onPress={() => setActiveIndex(index)}>
                            <Entypo name="dots-three-vertical" size={21} color={Colors.black} style={fellowListStyles.dotBtn}/>
                        </TouchableOpacity>
                        {
                            activeIndex == index 
                                ?
                                    <TouchableOpacity style={{ ...fellowListStyles.removeContainer }} activeOpacity={0.8} onPress={() => alert(`${item.name} has been removed from your fellow list`)}>
