        ...
        <SafeAreaView>
            ...
            <Container center padding={20}>
                ...
                <View style={{ marginVertical: 30 }}>
                    ...
                    <Text>Take resume photo or upload attachment file to semi-verify your account.</Text>
                </View>


                <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                    <TouchableOpacity style={styles.optionBtn}>
                        <Text color={Colors.primary} center weight='medium'>Take resume photo</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.optionBtn}>
